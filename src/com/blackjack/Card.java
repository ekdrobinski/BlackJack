...
public class Card {
    ...
    public Card(Suits suit, Values value) { ///constructor
        this.value = value;
        this.suit = suit;
    }
    ...
    public String toString() { ///allows to print out the value of the suit
        return this.suit.toString() + "-" + this.value.toString();
    }

    public Values getValue() { /// for checking values of the deck class, for how many points
        return this.value;
    }
